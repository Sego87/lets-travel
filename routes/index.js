...
router.post('/admin/add', hotelController.createHotelPost); // this is a post request (the route doesn't change indeed the corresponded action is empty - see add_hotel.pug).
