...
router.post('/admin/add', hotelController.upload, hotelController.createHotelPost); // this createHotelPost middleware is a post request (the route doesn't change indeed the corresponded action is empty - see add_hotel.pug). we also passedthe file uploader before the last middleware of the chain, the creation of the hotel
