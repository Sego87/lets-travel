...
hotelSchema.index({  // .index will allow us to index the fields we want to search from our model -we need it to use searchResult-. In this case we want to index and search for the name of the hotel and the country. We set them to be text strings
    hotel_name: 'text',
    country: 'text'
